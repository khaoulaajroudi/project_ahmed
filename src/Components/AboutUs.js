...
const AboutUs = () => {
  return (
    <div className='about'>
        <h1>Our History</h1>
        <p>Trippy is owned and managed by Trippy in fr, a leading brand in web designing services and e-commerce solutions,Trippy is counted for its expertise in web solutions and its top ranking business portals; Our invincible expertise and rich experience has raised our spirit to reach a head from client's expectation,Commendable success rate of other portals managed by Trippy is a live paradigm of our work excellence.</p>
